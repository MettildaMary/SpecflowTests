...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("languagae")]
...
#line 23
 testRunner.Then("that language should be dispayed on my listing", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("language")]
        public virtual void CheckIfUserIsAbleToDeleteALanguage()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("check if user is able to delete a language", new string[] {
                        "delete",
                        "language"});
#line 27
this.ScenarioSetup(scenarioInfo);
#line 7
 this.FeatureBackground();
#line 28
  testRunner.Given("I click on Delete button of a language", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 29
